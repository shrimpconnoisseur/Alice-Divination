# Alice-Divination
This project is a non-commercial academic work created for educational purposes only. Some graphical assets used on this website are not my original assets but are the property of their respective owner(s), including EPID Games, the developers of Trickcal. These assets have been sourced from publically available materials and are used here solely for demonstration and learning purposes. Specifically, they are sourced from Sefhi's website [Loot & Waifus](https://lootandwaifus.com/).
